---
name: theoneloop-plan
description: Analyze issues with the human and prepare TheOneLoop stories and sprints as complete increments. Use to plan the next sprint or agree on requirement changes; keep future sprints in draft.
---
...
Read the [protocol](references/protocol.md), [document format](references/documents.md), and the project's configuration and readiness assessment.
