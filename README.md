...
The CLI package layout has been checked locally, including complete and individual installations. Full sprint execution across all target agents remains to be validated. Public-source installation and licensing are still pending. [See the validation record](docs/publishing.md#validation-record).
...
- [Maintain the packages](docs/maintaining.md) or [prepare a public release](docs/publishing.md).
